...
export const NewCountry = () => {
	...
	let country = CountryCoords.filter(country => country.Country === "Maui")[0];
...
export const getDistanceAndBearing = (guessCounty, answerCountry) => {
	...
	console.log("answerCountry.Latitude " + answerCountry.Latitude);
	console.log("answerCountry.Longitude " + answerCountry.Longitude);
	console.log("guessCounty.Latitude " + guessCounty.Latitude);
	console.log("guessCounty.Longitude " + guessCounty.Longitude);


	console.log("guessCounty " + JSON.stringify(answerCountry));

	console.log("guessCounty " + JSON.stringify(guessCounty));
